		    ...
		    <div class="col-9 col-lg-9">
			  <nav aria-label="breadcrumb">
			    <ol class="breadcrumb breadcrumb-transparent">
				  ...
				  <li class="breadcrumb-item"><?=my_esc_html($documentation_catalog_current)?></li>
				</ol>
			  </nav>
			  ...
			  <?php
			    if (!empty($documentation_list)) {
					...
					foreach ($documentation_list as $list) {
						echo '<li class="mb-2"><a href="' . base_url($this->home_url . 'documentation_view/' . $list->slug) . '">' . $list->subject . '</a></li>';
					}
					echo '</ul>';
				}
				else {
					echo my_caption('front_documentation_no_entries_found');
				}
			  ?>
